...
\begin{figure}
  ...
  \centering
  \caption{Deformation of elements caused by particle motion.}
...
\begin{figure}
  \includegraphics[width=0.9375\textwidth]{../images/curved-mesh/mesh_deformation_ext.pdf}
  \centering
  \caption{Handling partially overlapping meshes.}
  \label{fig:mesh-deformation-ext}
\end{figure}
