...
\(b_0(s), b_1(t) \in \mathbf{R}^2\) we have Jacobian \(J =
...
To intersect two B\'{e}zier surfaces, we first find all points
where the edges intersect (Figure~\ref{fig:edge-intersections}).

\begin{figure}[H]
  \includegraphics[width=0.625\textwidth]{../images/curved-mesh/main_figure21.pdf}
  \centering
...
(see~\ref{sec:curved-polygons}) of intersection, we not only need to keep track
...
\begin{figure}[H]
  \includegraphics[width=0.625\textwidth]{../images/curved-mesh/main_figure22.pdf}
  \centering
...
\begin{figure}[H]
  \includegraphics[width=0.875\textwidth]{../images/curved-mesh/main_figure23.pdf}
  \centering
...
\end{equation}
\begin{figure}[H]
  \includegraphics[width=0.96875\textwidth]{../images/curved-mesh/main_figure24.pdf}
  \centering
...
E_3(r) = \left[ \begin{array}{c} 2 (6 r - 1) \\ 4 (2 r - 1)^2 \end{array}\right],
...
and we reparameterize on \(\left[\frac{1}{6}, \frac{3}{4}\right]\) to control
points
\begin{align}
  q_0 &= E_3\left(\frac{1}{6}\right) =
  \frac{16}{9} \left[ \begin{array}{c} 0 \\ 1 \end{array}\right] \\
  q_1 &= \left(1 - \frac{1}{6}\right) \left[\left(1 - \frac{3}{4}\right) p_0 +
    \frac{3}{4} p_1\right] +
    \frac{1}{6} \left[\left(1 - \frac{3}{4}\right) p_1 +
    \frac{3}{4} p_2\right] = \frac{1}{6} \left[
