...
\begin{figure}[H]
  \includegraphics[width=0.9375\textwidth]
                  {../images/curved-mesh/bbox_check.pdf}
  \centering
...
\textbf{most difficult} to implement. So the first part of the algorithm is
to find all points
...
(see~\ref{sec:curved-polygons} for more about curved polygons) of
...
\begin{figure}[H]
  \includegraphics[width=0.625\textwidth]
                  {../images/curved-mesh/locate_in_triangle.pdf}
  \centering
  \captionsetup{width=.75\linewidth}
