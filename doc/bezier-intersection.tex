...
\begin{figure}
  \includegraphics[width=0.9375\textwidth]
                  {../images/curved-mesh/subdivide_curve.pdf}
  \centering
  \captionsetup{width=.75\linewidth}
...
\begin{figure}
  \includegraphics[width=0.9375\textwidth]
                  {../images/curved-mesh/subdivision_process.pdf}
  \centering
  \captionsetup{width=.75\linewidth}
...
\begin{figure}
  \includegraphics[width=0.96875\textwidth]
                  {../images/curved-mesh/subdivision_linearized.pdf}
  \centering
  \captionsetup{width=.75\linewidth}
...
\begin{figure}
  \includegraphics[width=0.625\textwidth]
                  {../images/curved-mesh/main_figure21.pdf}
  \centering
  \captionsetup{width=.75\linewidth}
...
\begin{figure}
  \includegraphics[width=0.625\textwidth]
                  {../images/curved-mesh/main_figure22.pdf}
  \centering
  \captionsetup{width=.75\linewidth}
...
\begin{figure}
  \includegraphics[width=0.875\textwidth]
                  {../images/curved-mesh/main_figure23.pdf}
  \centering
  \captionsetup{width=.75\linewidth}
...
\begin{figure}
  \includegraphics[width=0.96875\textwidth]
                  {../images/curved-mesh/main_figure24.pdf}
  \centering
  \captionsetup{width=.75\linewidth}
